...
const blocks = [
  ...
  ['h2', 'Contrefaçon retenue ou rejetée : ce que montrent les décisions'],
  ['p', 'Face à une même utilisation, l’issue d’un procès PicRights AFP varie selon ce que le demandeur parvient à démontrer :'],
  ['table', [
    ['La contrefaçon est écartée si…', 'La contrefaçon est retenue si…'],
    [
      ['la photographie n’est pas jugée originale (captation « sur le vif », cadrage banal) ;', 'l’originalité est démontrée par des choix créatifs précis ;'],
      ['les preuves de l’utilisation sont insuffisantes ;', 'l’utilisation et la période sont clairement établies ;'],
      ['la titularité ou la cession des droits n’est pas prouvée.', 'l’AFP démontre détenir les droits invoqués.'],
    ],
  ]],
  ['p', 'Et même lorsque la contrefaçon est écartée, le juge peut examiner le **parasitisme** — d’où l’importance d’une analyse complète, et pas seulement de l’originalité.'],
...
const faq = [
  ...
  ['Combien de temps une procédure peut-elle durer ?', 'Une procédure au fond devant le tribunal judiciaire s’étale généralement sur plusieurs mois. C’est l’une des raisons pour lesquelles une résolution en phase amiable est souvent préférable, lorsqu’elle est possible.'],
  ['Dois-je constituer avocat dès la mise en demeure ?', 'Ce n’est pas obligatoire au stade amiable, mais une analyse dès la réception du courrier évite des réponses qui compliqueraient une défense ultérieure. En cas d’assignation, la constitution d’avocat devient nécessaire.'],
]
